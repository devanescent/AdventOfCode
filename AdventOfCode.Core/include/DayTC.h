...
namespace AdventOfCode
{
	...
	public:
		...
		{
			std::pair<std::vector<typename TProcessor::result_type>, typename TProcessor::context_type> res = m_proc.Process(input);
	...
	protected:
		...
		virtual uint64_t ExecutePart1(std::vector<typename TProcessor::result_type> input, typename TProcessor::context_type ctx) = 0;
		virtual uint64_t ExecutePart2(std::vector<typename TProcessor::result_type> input, typename TProcessor::context_type ctx) { return 0ull; }
